...
public interface PropertyChangeEnabledGameControls extends GameControls {
     ...
     * Expected type for newValue() java.awt.Point (the current location)
     */
     ...
     * Expected type for oldValue() java.awt.Point (the current location)
     */
     ...
     * Expected type for newValue() java.awt.Point (the starting location)
     */
